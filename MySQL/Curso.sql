...
select escola, curso, preco, tipo, professor from tb_curso inner join tb_categoria on categoria_id = id_categoria; 

select escola, curso, area, preco, tipo, professor from tb_curso inner join tb_categoria on categoria_id = id_categoria where area = "Programação";
