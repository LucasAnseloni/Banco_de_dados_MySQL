...
select nome, preco, tipo, ativo from tb_produto inner join tb_categorias on tb_categorias.categoria_id = tb_produto.categoria_id;

select nome, preco, tipo, ativo from tb_produto inner join tb_categorias on tb_categorias.categoria_id = tb_produto.categoria_id where tb_categorias.tipo = "Bovino";